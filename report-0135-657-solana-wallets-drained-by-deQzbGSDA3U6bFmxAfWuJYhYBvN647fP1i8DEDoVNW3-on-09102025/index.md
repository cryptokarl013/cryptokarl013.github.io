---
title: 650 Solana Wallets Compromised by deQzbGSDA3U6bFmxAfWuJYhYBvN647fP1i8DEDoVNW3. Report 0135
...
![Solana wallet drain victim 1 transaction details](images/victim1.png)
![Solana wallet drain victim 2 transaction details](images/victim2.png)
![Solana wallet drain victim 3 transaction details](images/victim3.png)
![Solana wallet drain victim 4 transaction details](images/victim4.png)
![Solana wallet drain victim 5 transaction details](images/victim5.png)
...
![Solana address to public name mapping table](images/address_solname.png)
...
![Top victims by amount of SOL drained](images/top_victims.png)
...
```
![Wallets that were drained twice](images/drained_twice.png)
...
order by count(*) desc
``` 
![Most frequently used addresses by compromised wallets](images/top_used_addresses.png)
...
order by count(*) desc
```
![Detailed breakdown of top used destination addresses](images/top_used_addresses2.png)
