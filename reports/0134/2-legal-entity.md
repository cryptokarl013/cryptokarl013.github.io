...
canonical_url: https://cryptokarl013.com/reports/0134/2-legal-entity/
image: https://cryptokarl013.com/assets/reports/0134/report_0134.2_cover.png
...
sitemap: false
redirect_from:
  - /report-0134-stolen-ETHs-Leads-to-NFT-Whales-n0b0dy-indifferent-and-investments-into-a-real-company-undeadscom/report-0134.2-undeadscom-lacks-clear-official-legal-entity-information/
---

<!--
This page names natural persons as they appear in public corporate registries.
Per the editorial standard, such pages are kept out of search engine indexes
...
The undeads.com terms of service page identifies **Sezual Pte Ltd** as the legal entity. The page does **not** disclose jurisdiction or registered office.

- Source: <https://undeads.com/legal/terms>

![undeads.com terms of service page naming Sezual Pte Ltd without specifying jurisdiction](/assets/reports/0134/image28.png)

The project's X profile [@undeadscom](https://x.com/undeadscom) discloses Singapore registration:
...
- <https://www.sgpbusiness.com/company/Sezual-Pte-Ltd>
- <https://www.dnb.com/business-directory/company-profiles.sezual_pte_ltd.e65e611ea6bd54cb6efc89e43f986f42.html>

![Singapore registry record for SEZUAL PTE. LTD. showing principal activity and registered key principal Yeow Lih Ren](/assets/reports/0134/image23.png)
...
![Corporate record showing Undeads Interactive Limited registered in the UK as publisher](/assets/reports/0134/image17.png)

![Additional record relating to Undeads Interactive Limited](/assets/reports/0134/image20.png)
...
- <https://www.linkedin.com/company/undeadscom/>
...
Limited public employee visibility on LinkedIn is a data point, not evidence of wrongdoing; the report records it because the editorial question under consideration is the difficulty of identifying the operating entity.

## The $UDS token

undeads.com publishes its own token, **$UDS**, listed on CoinMarketCap and other venues. Market cap was approximately **$50M in June 2025**.

- <https://coinmarketcap.com/currencies/undeads-games/>

## Publicly named founders (as they appear on undeads.com)

The undeads.com website publicly identifies its founders as **Grant Haseley** and **Leo Kahn**. The report records the public-facing profiles found by open search:

**Grant Haseley** (described on undeads.com as Founder)

- Personal Facebook (no undeads.com affiliation in profile content at time of review): <https://www.facebook.com/grant.haseley>
- LinkedIn profile (no undeads.com mentioned at time of review): <https://www.linkedin.com/in/grant-haseley-116a2398/>

**Leo Kahn** (described on undeads.com as Founder, CEO)

- Public conference video: <https://www.facebook.com/watch/?v=1002586494443152>

![Screenshot from undeads.com listing Grant Haseley and Leo Kahn as founders](/assets/reports/0134/image27.png)

![Public LinkedIn profile of Leo Kahn](/assets/reports/0134/image15.png)

These individuals are named here solely because **undeads.com itself publicly identifies them as founders**. The report makes no claim about them beyond that public identification and the state of their open profiles at review time.

## Other individuals publicly linked to the project
...
- **Verifiable:** Public filings list Sezual Pte Ltd (Singapore), Undeads Interactive Limited (UK), and a LinkedIn-declared UAE headquarters, without a disambiguating statement on undeads.com's own website.
- **Verifiable:** The Singapore registry's principal-activity classification for Sezual Pte Ltd excludes the product category publicly marketed under the undeads.com brand.
- **Inferred:** The three-jurisdiction inconsistency, combined with limited public visibility of the employee base, makes identifying a single point of accountability for the project unusually difficult.

These are findings about **corporate disclosure practices**. They are not allegations against any natural person named in this report. See [Disclaimer](/disclaimer/).

## Right of reply

undeads.com and any named individual may submit a response via [Corrections](/corrections/). Any response received will be published at the end of this report in full, up to 800 words.

> This report is based on publicly available corporate filings and public profile pages. It is not a criminal allegation against any natural person. See the [Disclaimer](/disclaimer/).
