...
* [**n0b0dy.eth**, **kfox.eth**, **indifferent.eth**, **indifferentguy.eth** are managed by a single individual or a coordinated group.](https://cryptokarl013.xyz/report-0134-stolen-ETHs-Leads-to-NFT-Whales-n0b0dy-indifferent-and-investments-into-a-real-company-undeadscom/report-0134.0-crypto-theft-from-switchere.com-connected-with-nft-whales-n0b0dy.eth-and-indifferent.eth/)

* [**Undeads.com** hides official legal entity information](https://cryptokarl013.xyz/report-0134-stolen-ETHs-Leads-to-NFT-Whales-n0b0dy-indifferent-and-investments-into-a-real-company-undeadscom/report-0134.2-undeadscom-lacks-clear-official-legal-entity-information/)
...
![Crunchbase profile of Undeads.com showing n0b0dy.eth and indifferent.eth as the only two listed investors and $6.3 million raised across Pre-Seed and Seed rounds](../images/image29.png)

![Crunchbase investor profiles for n0b0dy.eth and indifferent.eth linked to Undeads.com funding rounds](../images/image26.png)
...
![CoinMarketCap profile for Undeads Games listing n0b0dy.eth and indifferent.eth as investors](../images/image27.png)
...
![Etherscan transaction record showing n0b0dy wallet (0x7eb413211a9DE1cd2FE8b8Bb6055636c43F7d206) purchasing the undeads.eth ENS name on September 22, 2022](../images/undeads_ens.png)
...
![Web archive screenshot of the n0b0dy Twitter profile (@nobody_vault) from July 2024 actively promoting undeads.com](../images/n0b0dy_twitter.png)
...
![ENS history from ENSvolution showing the Twitter account @nobody_vault associated with the n0b0dy.eth ENS profile](../images/nobody_ens_history.png)
...
The link: https://www.ensvolution.xyz/?name=n0b0dy.eth
![ENSvolution history showing n0b0dy disassociated the @nobody_vault Twitter account from their n0b0dy.eth ENS profile on May 24, 2025](../images/nobody_ens_history2.png)

In August 2025, the **n0b0dy.eth** Twitter account no longer mentions **undeads.com**.
The link: https://twitter.com/nobody_vault
![Screenshot of the n0b0dy.eth Twitter account (@nobody_vault) as of August 2025 with all mentions of undeads.com removed](../images/n0b0dy_twitter2.png)
